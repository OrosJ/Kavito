...
// Configuración explícita para base de datos de pruebas - NO MODIFICAR ESTOS VALORES
const DB_TEST_NAME = 'kavito_test';
...
console.log(`Conectando a base de datos: ${DB_TEST_NAME}`);
console.log(`Host: ${DB_TEST_HOST}, Usuario: ${DB_TEST_USER}`);

// Crear instancia de Sequelize EXCLUSIVAMENTE para pruebas
// Esta es una conexión independiente de la aplicación principal
const testDB = new Sequelize(DB_TEST_NAME, DB_TEST_USER, DB_TEST_PASSWORD, {
  host: DB_TEST_HOST,
  port: DB_TEST_PORT,
  dialect: 'mysql',
  logging: false
...
async function initTestDB() {
  try {
    console.log('Verificando conexión a base de datos de pruebas...');
    ...
    console.log('Creando tablas en la base de datos de pruebas...');
